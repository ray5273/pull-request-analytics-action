...
Tracks changes to markdown files across pull requests, helping monitor documentation updates and identify patterns in documentation maintenance. Use the `markdown-changes` value in the `SHOW_STATS_TYPES` parameter.

|   user    | Added | Modified | Deleted | Total Files | Added Files | Modified Files | Deleted Files | Files with Keywords |
| :-------: | :---: | :------: | :-----: | :---------: | :---------: | :------------: | :-----------: | :-----------------: |
| **dev1**  |   3   |    2     |    0    |      5      | README.md, guide.md, tutorial.md | changelog.md, api.md | - | README.md (readme), guide.md (guide) |
| **dev2**  |   1   |    3     |    1    |      5      | migration.md | README.md, docs/setup.md, api-spec.md | old-guide.md | migration.md (migration), README.md (readme) |
| **total** |   4   |    5     |    1    |     10      | - | - | - | - |

#### Summary of Markdown Changes:
- **Total Markdown Files Added**: 4
- **Total Markdown Files Modified**: 5  
- **Total Markdown Files Deleted**: 1
- **Files with Special Keywords**: 4
...
| `SHOW_STATS_TYPES`          | Stats types that should be displayed in report. Values must be separated by commas. Can take values: `timeline`, `workload`, `pr-quality`, `code-review-engagement`, `response-time`, `markdown-changes`. Example: `timeline, workload, pr-quality, code-review-engagement, response-time, markdown-changes`                                                                                                                | `timeline, workload, pr-quality, code-review-engagement, response-time` |
...
| `MARKDOWN_KEYWORDS`         | Keywords to search for in markdown filenames when tracking markdown file changes. Values should be separated by commas. If not specified, default keywords will be used: `readme`, `doc`, `guide`, `tutorial`, `changelog`, `migration`, `api`. Example: `readme, documentation, spec`                                                                                                               | `readme, doc, guide, tutorial, changelog, migration, api`              |
